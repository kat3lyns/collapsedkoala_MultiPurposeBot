...
module.exports = {
    ...
    run: async(client, interaction) => {
        ...
        if(!interaction.isModalSubmit() && interaction.customId != "submitsuggestion") return;
        ...
        suggestions[interaction.id]["suggestion"] = interaction.fields.getTextInputValue("suggestion");
